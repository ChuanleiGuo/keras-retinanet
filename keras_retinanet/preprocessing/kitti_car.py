...
class KITTICarGenerator(Generator):
    def __init__(
        self,
        data_dir,
        set_name,
        ...
        **kwargs
        ...
        self.image_names          = [l.strip().split(None, 1)[0] for l in open(os.path.join(data_dir, 'main', set_name + '.txt')).readlines()]
        ...
        super(KITTICarGenerator, self).__init__(**kwargs)
    ...
    def image_aspect_ratio(self, image_index):
        path  = os.path.join(self.data_dir, 'training', 'image_2', self.image_names[image_index] + self.image_extension)
    ...
    def __parse_annotation(self, element):
        truncated = _findNode(element, 'truncated', parse=float)
    ...
    def __parse_annotations(self, xml_root):
        ...
        for i, element in enumerate(xml_root.iter('object')):
            ...
            if truncated and self.skip_truncated:
                continue
            if difficult and self.skip_occluded:
                continue
    ...
    def load_annotations(self, image_index):
        ...
        try:
            tree = ET.parse(os.path.join(self.data_dir, 'training', 'label_2car', 'xml', filename))
